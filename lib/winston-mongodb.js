...
exports.MongoDB = function (options) {
  ...
  this._opQueue = [];
  if (options.randomId && typeof options.randomId !== "function") {
    throw new Error("randomId option must be a function");
  }
...
MongoDB.prototype.log = function (info, cb) {
  ...
  process.nextTick(() => {
    ...
    if (this.randomId) entry._id = this.randomId();
    this.logDb
